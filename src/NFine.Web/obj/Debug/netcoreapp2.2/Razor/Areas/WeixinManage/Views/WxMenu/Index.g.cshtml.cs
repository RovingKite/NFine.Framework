#pragma checksum "E:\GitHub\NFineCore\src\NFine.Web\Areas\WeixinManage\Views\WxMenu\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "726b666f28deff845f325eb1dbe23b562c1c420e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_WeixinManage_Views_WxMenu_Index), @"mvc.1.0.view", @"/Areas/WeixinManage/Views/WxMenu/Index.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Areas/WeixinManage/Views/WxMenu/Index.cshtml", typeof(AspNetCore.Areas_WeixinManage_Views_WxMenu_Index))]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"726b666f28deff845f325eb1dbe23b562c1c420e", @"/Areas/WeixinManage/Views/WxMenu/Index.cshtml")]
    public class Areas_WeixinManage_Views_WxMenu_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "726b666f28deff845f325eb1dbe23b562c1c420e3890", async() => {
                BeginContext(31, 446, true);
                WriteLiteral(@"
    <title>Index</title>
...
");
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "726b666f28deff845f325eb1dbe23b562c1c420e4848", async() => {
                }
                );
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(801, 25740, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "726b666f28deff845f325eb1dbe23b562c1c420e7010", async() => {
                BeginContext(823, 3610, true);
                WriteLiteral(@"
                    ...
                    <div class=""ibox-content"" style=""min-height: 630px;"">
                        <div class=""form-horizontal"">
                            <div id=""menuBtnGroup"" class=""btn-group"">
                                ...
                                <button id=""btn_scancode_push"" class=""btn btn-white"" data-menutype=""scancode_push"" data-menutmpl=""keyTemplate""><i class=""fa fa-qrcode""></i>&nbsp;<span");
                WriteLiteral(@">扫码推事件</span></button>
                                ...
                                <button id=""btn_location_select"" class=""btn btn-white"" data-menutype=""location_select"" data-menutmpl=""keyTe");
                WriteLiteral(@"mplate""><i class=""fa fa-map-marker""></i>&nbsp;<span>弹出地理位置选择器</span></button>
...
");
        ...
        $(function () {
            $('#menuBtnGroup').find('button').bind('click', function () {
                ...
                if (menuType == 'view') {
                    ...
                    $('#choose-");
                WriteLiteral(@"material').bind('click', function () {
                        $.modalOpen({
                            id: ""Choose"",
                            title: ""选择素材"",
                    ...
                    $('#choose-news').unbind();
                    ");
                WriteLiteral(@"$('#choose-news').bind('click', function () {
                        $.modalOpen({
                            id: ""Choose"",
                            title: ""选择图文素材"",
   ...
   ");
                WriteLiteral(@"                     var menuData = result.MenuData.replace(""\\"", """");
                        menuJson = JSON.parse(menuData);
                        $('#nestable').find('ol').eq(0).html(template('nestableTemplate', menuJson.menu));
                        bindNestableEvents();
                    }
 ...
 ");
                WriteLiteral(@"                           obj.sub_button = [];
                        ...
                        object.sub_button = [];
                 ");
                WriteLiteral(@"       menu.button.push(object);
                    }
                });
                menuObj.menu = menu;
                console.log(menuObj);
        ...
        function bindNestableEvents() {
            ...
            $('.btnAdd').bind('click', function (event) {
                if ($(this).parent().next().find('.second-menu').length < 5) {
                   ...
                   ");
                WriteLiteral(@" $.modalAlert('自定义菜单最多包括3个一级菜单，每个一级菜单最多包含5个二级菜单。','warning');
                }
            });
                ...
                if (typeof (type) == 'undefined'||type == '') {
                    $('#menuBtnGroup').find('button').each(function (index, element) {
                        if ($(element).hasClass('btn-primary')) {
                            $(element).removeClass('btn-primary');
    ");
                WriteLiteral(@"                        $(element).removeClass('btn-selected');
                            $(element).addClass('btn-white');
                        }
                    })
                }
            ...
            $('.btnDelete').bind('click', function (event) {
                if ($(this).parent().pare");
                WriteLiteral(@"nt().hasClass('first-menu')) {
        ...
        function validData() {
            ...
            $.each(inputs, function (index, element) {
                ...
                //    if ($(element).val().trim() != '') {
         ");
                WriteLiteral(@"       //        $(element).parent().parent().removeClass('has-error');
    ...
    <script id=""materialTemplate"" type=""text/html"">
        <div class=""form-group"">
  ");
                WriteLiteral(@"          <label class=""col-sm-2 control-label"">素材Id</label>
            <div class=""col-sm-10"">
   ...
   ");
    ...
    <script id=""nestableTemplate"" type=""text/html"">
        ...
        <li class=""dd-item dd-nodrag first-menu"" data-id="""" data-type=""{{btn.type}}"" data-name=""{{btn.name}}"" data-key=""{{btn.key}}"" data-url=""{{btn.url}}"" data-mediaid=""{{btn.media_id}}"">
            ...
            {{if typeof(btn.sub_button) !='undefine");
                WriteLiteral(@"d'}}
            <ol class=""dd-list"">
 ...
 ");
                WriteLiteral(@"       <li class=""dd-item dd-nodrag first-menu"" data-id="""">
    ...
    <script id=""secondMenuTemplate"" type=""text/html"">
        <li class=""dd-item dd-nodrag second-menu"">
            <div class=""dd-handle"">
                ...
                WriteLiteral(@"-white pull-right btnDelete""><i class=""fa fa-trash""></i> 删除</button>
                <button class=""btn btn-xs btn-white pull-right btnEdit""><i class=""fa fa-pencil""></i> 编辑</button>
                <span class=""label label-info""><i class=""fa fa-bars""></i></span>
                <span></span>
            </div>
