                    ...
                    $.each(childNodes, function (i) {
                        ...
                        if (subrow.ParentId == row.Id && subrow.IsDisplay != false) {
                            ...
                            if (subchildNodes.length > 0) {
                                _html += '<a data-id="' + subrow.Id + '" href="#" class="dropdown-toggle" title="' + subrow.FullName+'"><i class="' + subrow.Icon + '"></i><span>' + subrow.FullName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
                                ...
                                _html += '<a  class="menuItem"  data-id="' + subrow.Id + '" href="' + subrow.UrlAddress + '" data-index="' + subrow.SortCode + '" data-target="' + subrow.Target + '" title="' + subrow.FullName +'"><i class="' + subrow.Icon + '"></i><span>' + subrow.FullName + '</span></a>';
                            }
                            _html += '</li>';
                        }
                    });
                        ...
                        if (subchildNodes.length > 0) {
                            ...
                            $.each(subchildNodes, function (i) {
                                ...
                                if (subrowsj.ParentId == subrow.Id) {
                                    _html += '<li>';
                                    _html += '<a class="menuItem" data-id="' + subrowsj.Id + '" href="' + subrowsj.UrlAddress + '" data-index="' + subrowsj.SortCode + '" title="' + subrowsj.FullName +'">' + subrowsj.FullName + '</a>';
                                    _html += '</li>';
                                }
                            });
                            _html += '</ul>';
                        } else {
                            _html += '<a  class="menuItem"  data-id="' + subrow.Id + '" href="' + subrow.UrlAddress + '" data-index="' + subrow.SortCode + '" title="' + subrow.FullName +'"><i class="' + subrow.Icon + '"></i><span>' + subrow.FullName + '</span></a>';
                        }
                        _html += '</li>';
                    }
                });
